...
<title>Add New Item - GiveAndTake</title>
<link
	...
	<div class="sidebar">
		...
		<nav>
			<a href="dashboard"><i class="fas fa-home"></i> Dashboard</a> <a
				href="MyItemsPage" class="active"><i class="fas fa-box-open"></i>
	...
	<div class="main">
		<div class="form-container">
			...
			<form action="AddNewItem" method="post">
				...
				<!-- Item Type -->
				<div class="form-group">
					<label for="itemType">Item Type</label> <select id="itemType"
						name="type" required>
