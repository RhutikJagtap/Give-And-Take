...
<title>Manage Items - GiveAndTake Admin</title>
<link
...
<body>
	...
	<div class="sidebar">
		...
		<nav>
			...
			<a href="ManageItemsPage" class="active"><i
				class="fas fa-box-open"></i> Manage Items</a> <a href="ManageUserPage"><i
	...
	<div class="main">
		<div class="page-header">
			<h3>Manage Items</h3>
			<a href="AllItems"><button>View All Items</button></a>
		</div>
...
%>
					<tr>
						...
						<td><span style="color: #f59e0b; font-weight: 600;"> <%= item.getStatus() %>
						</span></td>
						<td><a
							href="ApproveItem?action=approve&itemId=<%= item.getId() %>">
								<button class="approve-btn">Approve</button>
						</a> <a href="RejectItem?action=reject&itemId=<%= item.getId() %>">
...
%>
					<tr>
						<td colspan="6"
							...
							There are no pending request items available</td>
					</tr>
					<% 
    }
%>
